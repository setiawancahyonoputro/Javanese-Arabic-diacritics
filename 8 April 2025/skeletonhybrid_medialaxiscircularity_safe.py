...
# True  -> output binary mengikuti body mask (bersih seperti body mask)
# False -> pakai jalur despeckle + rescue yang lebih konservatif
# ============================================================
USE_BODY_MASK_BINARY = True
BODY_MASK_AREA = 220
BODY_MASK_H = 18
...
def safe_threshold_text(img_gray, otsu_bias_up=2, debug=False):
    """
    ...
    - hole preservation tetap dijaga
    """
...
gray, T = safe_threshold_text(img, otsu_bias_up=2, debug=True)
